      ...
      <div class="row items-push">
        <div class="col-sm-6 col-xxl-3">
          ...
          <div class="block block-rounded d-flex flex-column h-100 mb-0">
            <div class="block-content block-content-full flex-grow-1 d-flex justify-content-between align-items-center">
              <dl class="mb-0">
                <dt class="fs-3 fw-bold">{{ $userCount }}</dt>
        ...
        <div class="col-sm-6 col-xxl-3">
          ...
          <div class="block block-rounded d-flex flex-column h-100 mb-0">
            <div class="block-content block-content-full flex-grow-1 d-flex justify-content-between align-items-center">
              <dl class="mb-0">
                <dt class="fs-3 fw-bold">{{ $bookCount }}</dt>
                <dd class="fs-sm fw-medium fs-sm fw-medium text-muted mb-0">Total Books</dd>
              </dl>
              <div class="item item-rounded-lg bg-body-light">
            ...
            <div class="bg-body-light rounded-bottom">
              <a class="block-content block-content-full block-content-sm fs-sm fw-medium d-flex align-items-center justify-content-between" href="{{ route('books.index') }}">
        ...
        <div class="col-sm-6 col-xxl-3">
          ...
          <div class="block block-rounded d-flex flex-column h-100 mb-0">
            <div class="block-content block-content-full flex-grow-1 d-flex justify-content-between align-items-center">
              <dl class="mb-0">
                <dt class="fs-3 fw-bold">{{ $availableBooks }}</dt>
                <dd class="fs-sm fw-medium fs-sm fw-medium text-muted mb-0">Available Books</dd>
              </dl>
              <div class="item item-rounded-lg bg-body-light">
                <i class="fa fa-check-circle fs-3 text-primary"></i>
              </div>
            </div>
            <div class="bg-body-light rounded-bottom">
              <a class="block-content block-content-full block-content-sm fs-sm fw-medium d-flex align-items-center justify-content-between" href="{{ route('books.index') }}">
        ...
        <div class="col-sm-6 col-xxl-3">
          ...
          <div class="block block-rounded d-flex flex-column h-100 mb-0">
            <div class="block-content block-content-full flex-grow-1 d-flex justify-content-between align-items-center">
              <dl class="mb-0">
                <dt class="fs-3 fw-bold">{{ $borrowedBooks }}</dt>
                <dd class="fs-sm fw-medium fs-sm fw-medium text-muted mb-0">Borrowed Books</dd>
              </dl>
              <div class="item item-rounded-lg bg-body-light">
            ...
            <div class="bg-body-light rounded-bottom">
              <a class="block-content block-content-full block-content-sm fs-sm fw-medium d-flex align-items-center justify-content-between" href="{{ route('borrowings.index') }}">
