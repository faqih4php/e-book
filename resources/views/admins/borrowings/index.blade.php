...
@section('title', 'Dashboard | Borrowing Requests')
@section('css')
    ...
    <div class="content">
        <div class="d-flex flex-column flex-md-row justify-content-md-between align-items-md-center py-2 text-center text-md-start">
            <div class="flex-grow-1 mb-1 mb-md-0">
                <h1 class="h3 fw-bold mb-2">Borrowing Requests</h1>
                <h2 class="h6 fw-medium text-muted mb-0">Manage pending book borrow requests.</h2>
            </div>
        </div>
    </div>
    <div class="content">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <form action="{{ route('borrowings.reject', $borrowing->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        <button type="submit" class="btn btn-sm btn-alt-danger" title="Reject">
