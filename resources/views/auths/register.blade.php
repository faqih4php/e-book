  ...
  <body>
    ...
    <div id="page-container">
      ...
      <main id="main-container">
        <!-- Page Content -->
        <div class="bg-image" style="background-image: url('{{ asset('media/photos/photo14.jpg') }}');">
                ...
                <div class="w-100">
                  ...
                  <div class="row g-0 justify-content-center">
                    <div class="col-sm-8 col-xl-5">
                      <form class="js-validation-signup" action="{{ route('auths.register.post') }}" method="POST">
                        @csrf
                        <div class="mb-4">
                          ...
                          <div class="d-md-flex align-items-md-center justify-content-md-between">
                            ...
                            <div class="text-center">
                              <button type="submit" class="btn btn-lg btn-alt-success">
                                <i class="si si-plus me-1 opacity-50"></i> Sign Up
                              </button>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="text-center">
                        <span>
                            Already have an account? <a href="{{ route('auths.login') }}" class="">Sign In</a>
                        </span>
                    </div>
                    </div>
                  </div>
