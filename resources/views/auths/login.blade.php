                ...
                <div class="w-100">
                  ...
                  <div class="text-center mb-5">
                    ...
                    <p class="fw-medium text-muted">
                      Welcome, please login or <a href="{{ route('auths.register') }}">sign up</a> for a new account.
                    </p>
                  </div>
                  <!-- END Header -->
                  ...
                  {{-- Flash message jika diredirect karena belum login --}}
                  @if (session('error'))
                  ...
                  <div class="row g-0 justify-content-center">
                    <div class="col-sm-8 col-xl-4">
                      <form class="js-validation-signin" action="{{ route('auths.login.post') }}" method="POST">
                        @csrf
                        <div class="mb-4">
                          <input type="email" class="form-control form-control-lg form-control-alt py-3" id="email" name="email" placeholder="Email" value="{{ old('email') }}" required>
                          @error('email')
                            <div class="text-danger mt-2">{{ $message }}</div>
                          @enderror
                        </div>
                        <div class="mb-4">
                          <input type="password" class="form-control form-control-lg form-control-alt py-3" id="password" name="password" placeholder="Password" required>
                          @error('password')
                            <div class="text-danger mt-2">{{ $message }}</div>
                          @enderror
                        </div>
